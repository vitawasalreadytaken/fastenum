...
class TestHelpers(unittest.TestCase):
	...
	def test_is_descriptor(self):
		...
		for attr in ('__get__','__set__','__delete__'):
			obj = foo()
			self.assertFalse(fastenum._is_descriptor(obj))
			setattr(obj, attr, 1)
			self.assertTrue(fastenum._is_descriptor(obj))

	#def test_is_sunder(self):
	#	for s in ('_a_', '_aa_'):
	#		self.assertTrue(fastenum._is_sunder(s))

	#	for s in ('a', 'a_', '_a', '__a', 'a__', '__a__', '_a__', '__a_', '_',
	#			'__', '___', '____', '_____',):
	#		self.assertFalse(fastenum._is_sunder(s))

	#def test_is_dunder(self):
	#	for s in ('__a__', '__aa__'):
	#		self.assertTrue(fastenum._is_dunder(s))
	#	for s in ('a', 'a_', '_a', '__a', 'a__', '_a_', '_a__', '__a_', '_',
	#			'__', '___', '____', '_____',):
	#		self.assertFalse(fastenum._is_dunder(s))
...
class TestEnum(unittest.TestCase):
	...
	#	fastenum._make_class_unpicklable(BadPickle)
...
# |\x20\x20
# |  ----------------------------------------------------------------------
# |  Data descriptors inherited from fastenum.Enum:
# |\x20\x20
# |  name
...
# |\x20\x20
# |  ----------------------------------------------------------------------
# |  Data descriptors inherited from fastenum.EnumMeta:
# |\x20\x20
# |  __members__
